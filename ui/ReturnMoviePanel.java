 ...
 * @author RaghuNandan
 */
public class ReturnMoviePanel extends javax.swing.JPanel {
    List<JCheckBox> allcheckboxes = new ArrayList<>();
    private static JPanel topPanel = new JPanel();
    private static JPanel bottomPanel = new JPanel();
    /**
     * Creates new form ReturnMoviePanel
     */
    public ReturnMoviePanel() {
        initComponents();
...
//        scrollFrame.setPreferredSize(new Dimension( 2000,300));
        ...
        JButton payButton = new JButton("Reserve Movie");
